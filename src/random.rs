pub mod random {
    ...
    impl Mt19337 {
        ...
        const SEED_MULT: Wrapping<u32> = Wrapping(0x6c078965);
        const UPPER_MASK: Wrapping<u32> = Wrapping(0x80000000);
        const LOWER_MASK: Wrapping<u32> = Wrapping(0x7fffffff);
        const FIRST_MASK: Wrapping<u32> = Wrapping(0x9d2c5680);
        const SECOND_MASK: Wrapping<u32> = Wrapping(0xefc60000);
        const TWIST_CONST: Wrapping<u32> = Wrapping(0x9908b0df);
